<div class="<?php print $classes ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <?php if ($content['row1l'] || $content['row1c'] || $content['row1r']): ?>
  <div class="container-fullwidth row1">
    <div class="container row1">
      <div class="row row1">
        ...
        <?php endif; ?>
        <?php if ($content['row1c']): ?>
          <?php print $content['row1c']; ?>
        <?php endif; ?>
  ...
  <?php if ($content['row2l'] || $content['row2c'] || $content['row2r']): ?>
  <div class="container-fullwidth row2">
    <div class="container row2">
      <div class="row row2">
        ...
        <?php endif; ?>
        <?php if ($content['row2c']): ?>
          <?php print $content['row2c']; ?>
        <?php endif; ?>
  ...
  <?php if ($content['row3l'] || $content['row3c'] || $content['row3r']): ?>
  <div class="container-fullwidth row3">
    <div class="container row3">
      <div class="row row3">
        ...
        <?php endif; ?>
        <?php if ($content['row3c']): ?>
          <?php print $content['row3c']; ?>
        <?php endif; ?>
  ...
  <?php if ($content['row4l'] || $content['row4c'] || $content['row4r']): ?>
  <div class="container-fullwidth row4">
    <div class="container row4">
      <div class="row row4">
        ...
        <?php endif; ?>
        <?php if ($content['row4c']): ?>
          <?php print $content['row4c']; ?>
        <?php endif; ?>
  ...
  <?php if ($content['row5l'] || $content['row5c'] || $content['row5r']): ?>
  <div class="container-fullwidth row5">
    <div class="container row5">
      <div class="row row5">
        ...
        <?php endif; ?>
        <?php if ($content['row5c']): ?>
          <?php print $content['row5c']; ?>
        <?php endif; ?>
